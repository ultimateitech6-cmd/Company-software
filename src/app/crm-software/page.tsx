...
export const metadata: Metadata = {
  title: "Customizable CRM Software Platform | YourCompany Software Solutions",
  description: "Accelerate your lead conversions with customizable CRM features pipeline, Customer 360 histories, automated follow-ups, and team metrics logs.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-left max-w-xl">
              ...
              <p className="text-sm sm:text-base text-slate-655 dark:text-slate-350 leading-relaxed">
                Empower your sales and support teams to drive growth. Our customizable CRM gives reps instant visibility into active lead pipelines, past emails and contact history, automated tasks, call diaries, and sales quotas.
              </p>
            ...
            <div className="hidden lg:flex justify-center">
              ...
              <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl w-full max-w-md shadow-xl text-slate-350 space-y-4">
                <div className="flex items-center gap-3 border-b border-slate-850 pb-4">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white leading-none">YourCompany CRM</h4>
      ...
      <section className="pt-10 pb-20 md:pt-12 md:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            title="Accelerate Leads to Closed Deals"
            subtitle="Explore our comprehensive collection of customer-facing modules. Get deep pipeline analytics, automated sales routing, and full historical logs configured for your team."
          />
